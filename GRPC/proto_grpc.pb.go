...
const (
	Broadcast_CreateStream_FullMethodName     = "/SimpleGuide.Broadcast/CreateStream"
	Broadcast_BroadcastMessage_FullMethodName = "/SimpleGuide.Broadcast/BroadcastMessage"
)
